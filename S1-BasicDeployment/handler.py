...
def classify_image(event, context) : 
    try: 
        ...
        print("Get Prediction returned:",prediction, type(prediction), imagenet_labels[int(prediction)])
        predicted_val = imagenet_labels[int(prediction)]
        predicted_str = f'That seems to be a {predicted_val}'
